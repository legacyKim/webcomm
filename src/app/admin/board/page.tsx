    ...
    return (
        <div className="admin_page">
            ...
            <menu className="left_menu">
                <button onClick={() => { setSection('boardManage') }}>게시판 관리</button>
                <button onClick={() => { setSection('boardConManage') }}>게시글 관리</button>
                <button onClick={() => { setSection('boardStorage') }}>게시글 보관</button>
            </menu>

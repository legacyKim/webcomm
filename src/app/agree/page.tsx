          ...
          <div className={styles.membership}>
            ...
            <div className={styles.membership_box}>
              <div className={styles.membership_contents}>
                ...
                <ul>
                  <li>
                    회원가입은 이용자가 사이트가 정한 가입 양식에 따라 정보를 입력하고 본 약관에 동의한 후, 사이트가
                    이를 승인함으로써 완료됩니다.
                  </li>
                  <li>
                ...
                <ul>
                  <li>
                    이 약관은 대한민국 법률에 따라 해석되며, 서비스 이용 중 발생하는 분쟁은 민사소송법에 따른 관할
                    법원에 제소됩니다.
                  </li>
                </ul>
          ...
          <div className={styles.membership}>
            ...
            <div className={styles.membership_box}>
              <div className={styles.membership_contents}>
                ...
                <ol>
                  <li>
                    약관 및 서비스와 관련된 분쟁은 대한민국 법에 따르며, 관할 법원은 운영자 주소지 관할을 따릅니다.
                  </li>
                </ol>

        ...
        <div className={styles.container}>
            <div className={styles.page}>
                <div className={styles.membership_wrap}>
                    <div className={styles.membership}>
                        ...
                        <div className="checkbox">
                            <input type="checkbox" id="member_agree_01" name="member_agree_01" className="hidden_checkbox" />
                    ...
                    <div className={styles.membership}>
                        ...
                        {/* 체크박스 */}
                        <div className="checkbox">
                            <input type="checkbox" id="member_agree_02" name="member_agree_02" className="hidden_checkbox" />
                ...
                <div className="btn_wrap">
                    <Link href="/user" className={`btn btn_width`}>회원가입</Link>
                </div>
            </div>
        </div>
    )

                        ...
                        <form onSubmit={userPost} className={styles.form}>
                            ...
                            <div className={styles.input_group}>
                                <div className={styles.input_box} ref={boxNickRef}>
                                    <div className={styles.input_bg}></div>
                                    <label className={styles.label_common} htmlFor="userid" ref={labelNickRef}>별명</label>
                                    <input className={styles.input_common}
                                        ref={inputNickRef}
                                        onFocus={() => handleFocus(labelNickRef, boxNickRef)}
                                        onBlur={() => { inputNickRef.current && inputNickRef.current.value === "" && handleBlur(labelNickRef, boxNickRef) }}
                                        type="text"
                                        id="userNickname"
                                        name="userNickname"
                                        value={userNickname}
                            ...
                            {!idDupliCheck && (
                                <div className="btn_wrap">
                                    <button onClick={() => { idCheck(); }} type='button' className={`btn 
                            ...
                            <div className={styles.input_group}>
                                <div className={styles.input_box} ref={boxPwRef}>
                                    <div className={styles.input_bg}></div>
                                    <label className={styles.label_common} htmlFor="user_password" ref={labelPwRef}>비밀번호</label>
                                    <input className={styles.input_common}
                                        ref={inputPwRef}
                            ...
                            <div className={styles.input_group}>
                                <div className={styles.input_box} ref={boxPwcRef}>
                                    <div className={styles.input_bg}></div>
                                    <label className={styles.label_common} htmlFor="user_password_check" ref={labelPwcRef}>비밀번호 확인</label>
                                    <input className={styles.input_common}
                                        ref={inputPwcRef}
                                        onFocus={() => handleFocus(labelPwcRef, boxPwcRef)}
                                        onBlur={() => { inputPwcRef.current && inputPwcRef.current.value === "" && handleBlur(labelPwcRef, boxPwcRef) }}
                                        type="password"
                            ...
                            <span className={`${styles.notice} ${userPasswordNotice === "비밀번호가 일치하지 않습니다!"
                                ? styles.notice_false
                            ...
                            <div className={styles.input_group}>
                                <div className={styles.input_box} ref={boxEmailRef}>
                                    <div className={styles.input_bg}></div>
                                    <label className={styles.label_common} htmlFor="user_email" ref={labelEmailRef}>이메일</label>
                                    <input className={styles.input_common}
                                        ref={inputEmailRef}
                                        onFocus={() => handleFocus(labelEmailRef, boxEmailRef)}
                                        onBlur={() => { inputEmailRef.current && inputEmailRef.current.value === "" && handleBlur(labelEmailRef, boxEmailRef) }}
                                        type="text"
                                        id="user_email"
                                        name="user_email"
                                        value={userEmail}
                                ...
                                <button type='button' onClick={() => { emailCheck(); }} className="btn_line_grey">인증번호
                                    <br />
                                    요청</button>
                            </div>
                            ...
                            <div className={styles.input_group}>
                                <div className={styles.input_box} ref={boxCertifyNumRef}>
                                    <div className={styles.input_bg}></div>
                                    <label className={styles.label_common} htmlFor="certify_num" ref={labelCertifyNumRef}>인증번호</label>
                                    <input className={styles.input_common}
                                        ref={inputCertifyNumRef}
                                        onFocus={() => handleFocus(labelCertifyNumRef, boxCertifyNumRef)}
                                        onBlur={() => { inputCertifyNumRef.current && inputCertifyNumRef.current.value === "" && handleBlur(labelCertifyNumRef, boxCertifyNumRef) }}
                                        type="text"
                                        id="certify_num"
                                        name="certify_num"
                                        value={certifyNum}
                            ...
                            <div className="btn_wrap">
                                ...
                                }} type="submit" className={`btn ${certifyAgree && idDupliCheck && userPassword === userPasswordCheck ? "" : "btn_nonactive"}`}>
                                    회원가입
                                </button>
                            </div>
                        </form>

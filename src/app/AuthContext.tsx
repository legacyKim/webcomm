...
export function AuthProvider({ children, username, userId, userNick, userProfile, userEmail }:
    { children: React.ReactNode; username: string; userId: number; userNick: string; userProfile: string; userEmail: string; }) {
    ...
    return (
        <AuthContext.Provider value={{ isUsername, setIsUsername, isUserId, setIsUserId, isUserNick, setIsUserNick, isUserProfile, setIsUserProfile, isUserEmail, setIsUserEmail, loginStatus, setLoginStatus }}>
            {children}
